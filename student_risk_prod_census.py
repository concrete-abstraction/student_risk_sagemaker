...
#%%
# Random forest model
# rfc = RandomForestClassifier(n_estimators=500, max_depth=8, max_features='sqrt', verbose=True).fit(x_train, y_train)
...
mlp = MLPClassifier(hidden_layer_sizes=(75,50,25), activation='relu', solver='sgd', alpha=1.0, learning_rate_init=0.001, n_iter_no_change=20, max_iter=2000, verbose=True).fit(x_train, y_train)
