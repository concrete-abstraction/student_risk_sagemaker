...
#%%
# SAS dataset builder
builder.DatasetBuilder.build_admissions()
...
pullm_testing_set = testing_set[(training_set['adj_acad_prog_primary_campus'] == 'PULLM') & (training_set['adj_admit_type_cat'] == 'FRSH')][[
                            'emplid',
							'ENRL_IND',
                            # 'acad_year',
							# 'age_group', 
...
vanco_logit_df = training_set[(training_set['adj_acad_prog_primary_campus'] == 'PULLM') & (training_set['adj_admit_type_cat'] == 'FRSH')][[
                        'enrl_ind', 
                        # 'acad_year',
                        # 'age_group', 
                        # 'age',
...
vanco_training_set = training_set[(training_set['adj_acad_prog_primary_campus'] == 'PULLM') & (training_set['adj_admit_type_cat'] == 'FRSH')][[
                            'emplid',
                            'enrl_ind', 
                        	# 'acad_year',
							# 'age_group', 
...
vanco_testing_set = testing_set[(training_set['adj_acad_prog_primary_campus'] == 'PULLM') & (training_set['adj_admit_type_cat'] == 'FRSH')][[
                            'emplid',
							'ENRL_IND',
                            # 'acad_year',
							# 'age_group', 
...
trici_logit_df = training_set[(training_set['adj_acad_prog_primary_campus'] == 'PULLM') & (training_set['adj_admit_type_cat'] == 'FRSH')][[
                        'enrl_ind', 
                        # 'acad_year',
                        # 'age_group', 
                        # 'age',
...
trici_training_set = training_set[(training_set['adj_acad_prog_primary_campus'] == 'PULLM') & (training_set['adj_admit_type_cat'] == 'FRSH')][[
                            'emplid',
                            'enrl_ind', 
                        	# 'acad_year',
							# 'age_group', 
...
trici_testing_set = testing_set[(training_set['adj_acad_prog_primary_campus'] == 'PULLM') & (training_set['adj_admit_type_cat'] == 'FRSH')][[
                            'emplid',
							'ENRL_IND',
                            # 'acad_year',
							# 'age_group', 
...
pullm_outlier_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\pullm_outlier_set.csv', encoding='utf-8', index=False)
...
vanco_outlier_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\vanco_outlier_set.csv', encoding='utf-8', index=False)
...
trici_outlier_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\trici_outlier_set.csv', encoding='utf-8', index=False)
...
pullm_tomek_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\pullm_tomek_set.csv', encoding='utf-8', index=False)
...
vanco_tomek_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\vanco_tomek_set.csv', encoding='utf-8', index=False)
...
pullm_y, pullm_x = dmatrices('enrl_ind ~ male + underrep_minority + pct_blk + pct_ai + pct_hawi + pct_two + pct_hisp \
                + city_large + city_mid + city_small + suburb_large + suburb_mid + suburb_small \
                + pell_eligibility_ind \
                + first_gen_flag \
                + fall_avg_difficulty + fall_avg_pct_withdrawn + fall_avg_pct_withdrawn \
				+ fall_lec_count + fall_lab_count \
				+ total_fall_contact_hrs \
                + resident + gini_indx + median_inc \
            	+ high_school_gpa + remedial \
            	+ unmet_need_ofr', data=pullm_logit_df, return_type='dataframe')
...
vanco_y, vanco_x = dmatrices('enrl_ind ~ male + underrep_minority + pct_blk + pct_ai + pct_hawi + pct_two + pct_hisp \
                + city_large + city_mid + city_small + suburb_large + suburb_mid + suburb_small \
                + pell_eligibility_ind \
                + first_gen_flag \
                + fall_avg_difficulty + fall_avg_pct_withdrawn + fall_avg_pct_withdrawn \
                ...
                + resident + gini_indx + median_inc \
            	+ high_school_gpa + remedial \
            	+ unmet_need_ofr', data=vanco_logit_df, return_type='dataframe')
...
trici_y, trici_x = dmatrices('enrl_ind ~ male + underrep_minority + pct_blk + pct_ai + pct_hawi + pct_two + pct_hisp \
                + city_large + city_mid + city_small + suburb_large + suburb_mid + suburb_small \
                + pell_eligibility_ind \
                + first_gen_flag \
                + fall_avg_difficulty + fall_avg_pct_withdrawn + fall_avg_pct_withdrawn \
                ...
                + resident + gini_indx + median_inc \
            	+ high_school_gpa + remedial \
            	+ unmet_need_ofr', data=trici_logit_df, return_type='dataframe')
