...
vanco_testing_set = testing_set[(training_set['adj_acad_prog_primary_campus'] == 'VANCO') & (training_set['adj_admit_type_cat'] == 'FRSH')][[
                            'emplid',
							# 'enrl_ind', 
							# 'acad_year',
							# 'age_group', 
...
trici_testing_set = testing_set[(training_set['adj_acad_prog_primary_campus'] == 'TRICI') & (training_set['adj_admit_type_cat'] == 'FRSH')][[
                            'emplid',
							# 'enrl_ind', 
							# 'acad_year',
							# 'age_group', 
...
pullm_y, pullm_x = dmatrices('enrl_ind ~ pop_dens + educ_rate \
            	...
            	+ high_school_gpa + midterm_gpa_avg + midterm_gpa_ind + remedial \
...
pullm_current_outcome['model_id'] = 3
...
vanco_current_outcome['model_id'] = 3
...
trici_current_outcome['model_id'] = 3
