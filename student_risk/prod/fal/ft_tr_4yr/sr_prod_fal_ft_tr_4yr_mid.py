...
import shap
from student_risk import build_ft_tr_4yr_prod, config
...
#%%
# SAS dataset builder
build_ft_tr_4yr_prod.DatasetBuilderProd.build_census_prod()

#%%
# Import pre-split data
validation_set = pd.read_csv('Z:\\Nathan\\Models\\student_risk\\datasets\\ft_tr_4yr_validation_set.csv', encoding='utf-8', low_memory=False)
training_set = pd.read_csv('Z:\\Nathan\\Models\\student_risk\\datasets\\ft_tr_4yr_training_set.csv', encoding='utf-8', low_memory=False)
testing_set = pd.read_csv('Z:\\Nathan\\Models\\student_risk\\datasets\\ft_tr_4yr_testing_set.csv', encoding='utf-8', low_memory=False)
...
print('\nStandard logistic model for Pullman fourth-year transfers...\n')
...
print('\nStandard logistic model for Vancouver fourth-year transfers...\n')
...
print('\nStandard logistic model for Tri-Cities fourth-year transfers...\n')
...
print('\nStandard logistic model for University fourth-year transfers...\n')
...
#%%
print('Run machine learning models for fourth-year transfers...\n')
...
pullm_pred_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\pullm\\pullm_ft_tr_4yr_pred_outcome.csv', encoding='utf-8', index=False)
...
vanco_pred_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\vanco\\vanco_ft_tr_4yr_pred_outcome.csv', encoding='utf-8', index=False)
...
trici_pred_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\trici\\trici_ft_tr_4yr_pred_outcome.csv', encoding='utf-8', index=False)
...
univr_pred_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\univr\\univr_ft_tr_4yr_pred_outcome.csv', encoding='utf-8', index=False)
...
pullm_aggregate_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\pullm\\pullm_ft_tr_4yr_aggregate_outcome.csv', encoding='utf-8', index=False)
...
vanco_aggregate_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\vanco\\vanco_ft_tr_4yr_aggregate_outcome.csv', encoding='utf-8', index=False)
...
trici_aggregate_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\trici\\trici_ft_tr_4yr_aggregate_outcome.csv', encoding='utf-8', index=False)
...
univr_aggregate_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\univr\\univr_ft_tr_4yr_aggregate_outcome.csv', encoding='utf-8', index=False)
...
if not os.path.isfile('Z:\\Nathan\\Models\\student_risk\\predictions\\pullm\\pullm_ft_tr_4yr_student_outcome.csv'):
	pullm_current_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\pullm\\pullm_ft_tr_4yr_student_outcome.csv', encoding='utf-8', index=False)
	pullm_current_outcome.to_sql('student_outcome', con=auto_engine, if_exists='append', index=False, schema='oracle_int.dbo')
else:
	pullm_prior_outcome = pd.read_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\pullm\\pullm_ft_tr_4yr_student_outcome.csv', encoding='utf-8', low_memory=False)
	pullm_prior_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\pullm\\pullm_ft_tr_4yr_student_backup.csv', encoding='utf-8', index=False)
	pullm_student_outcome = pd.concat([pullm_prior_outcome, pullm_current_outcome])
	pullm_student_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\pullm\\pullm_ft_tr_4yr_student_outcome.csv', encoding='utf-8', index=False)
	pullm_current_outcome.to_sql('student_outcome', con=auto_engine, if_exists='append', index=False, schema='oracle_int.dbo')

#%%
# Vancouver to csv and to sql
if not os.path.isfile('Z:\\Nathan\\Models\\student_risk\\predictions\\vanco\\vanco_ft_tr_4yr_student_outcome.csv'):
	vanco_current_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\vanco\\vanco_ft_tr_4yr_student_outcome.csv', encoding='utf-8', index=False)
	vanco_current_outcome.to_sql('student_outcome', con=auto_engine, if_exists='append', index=False, schema='oracle_int.dbo')
else:
	vanco_prior_outcome = pd.read_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\vanco\\vanco_ft_tr_4yr_student_outcome.csv', encoding='utf-8', low_memory=False)
	vanco_prior_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\vanco\\vanco_ft_tr_4yr_student_backup.csv', encoding='utf-8', index=False)
	vanco_student_outcome = pd.concat([vanco_prior_outcome, vanco_current_outcome])
	vanco_student_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\vanco\\vanco_ft_tr_4yr_student_outcome.csv', encoding='utf-8', index=False)
	vanco_current_outcome.to_sql('student_outcome', con=auto_engine, if_exists='append', index=False, schema='oracle_int.dbo')

#%%
# Tri-Cities to csv and to sql
if not os.path.isfile('Z:\\Nathan\\Models\\student_risk\\predictions\\trici\\trici_ft_tr_4yr_student_outcome.csv'):
	trici_current_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\trici\\trici_ft_tr_4yr_student_outcome.csv', encoding='utf-8', index=False)
	trici_current_outcome.to_sql('student_outcome', con=auto_engine, if_exists='append', index=False, schema='oracle_int.dbo')
else:
	trici_prior_outcome = pd.read_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\trici\\trici_ft_tr_4yr_student_outcome.csv', encoding='utf-8', low_memory=False)
	trici_prior_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\trici\\trici_ft_tr_4yr_student_backup.csv', encoding='utf-8', index=False)
	trici_student_outcome = pd.concat([trici_prior_outcome, trici_current_outcome])
	trici_student_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\trici\\trici_ft_tr_4yr_student_outcome.csv', encoding='utf-8', index=False)
	trici_current_outcome.to_sql('student_outcome', con=auto_engine, if_exists='append', index=False, schema='oracle_int.dbo')

#%%
# University to csv and to sql
if not os.path.isfile('Z:\\Nathan\\Models\\student_risk\\predictions\\univr\\univr_ft_tr_4yr_student_outcome.csv'):
	univr_current_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\univr\\univr_ft_tr_4yr_student_outcome.csv', encoding='utf-8', index=False)
	univr_current_outcome.to_sql('student_outcome', con=auto_engine, if_exists='append', index=False, schema='oracle_int.dbo')
else:
	univr_prior_outcome = pd.read_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\univr\\univr_ft_tr_4yr_student_outcome.csv', encoding='utf-8', low_memory=False)
	univr_prior_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\univr\\univr_ft_tr_4yr_student_backup.csv', encoding='utf-8', index=False)
	univr_student_outcome = pd.concat([univr_prior_outcome, univr_current_outcome])
	univr_student_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\univr\\univr_ft_tr_4yr_student_outcome.csv', encoding='utf-8', index=False)
	univr_current_outcome.to_sql('student_outcome', con=auto_engine, if_exists='append', index=False, schema='oracle_int.dbo')

#%%
# Pullman top-N SHAP values to csv and to sql
pullm_shap_file = open('Z:\\Nathan\\Models\\student_risk\\shap\\pullm\\pullm_ft_tr_4yr_shap.csv', 'w', newline='')
...
vanco_shap_file = open('Z:\\Nathan\\Models\\student_risk\\shap\\vanco\\vanco_ft_tr_4yr_shap.csv', 'w', newline='')
...
trici_shap_file = open('Z:\\Nathan\\Models\\student_risk\\shap\\trici\\trici_ft_tr_4yr_shap.csv', 'w', newline='')
...
univr_shap_file = open('Z:\\Nathan\\Models\\student_risk\\shap\\univr\\univr_ft_tr_4yr_shap.csv', 'w', newline='')
...
joblib.dump(pullm_xgbrf, f'Z:\\Nathan\\Models\\student_risk\\models\\pullm_ft_tr_4yr_model_v{sklearn.__version__}.pkl')

#%%
# Vancouver model output
joblib.dump(vanco_xgbrf, f'Z:\\Nathan\\Models\\student_risk\\models\\vanco_ft_tr_4yr_model_v{sklearn.__version__}.pkl')

#%%
# Tri-Cities model output
joblib.dump(trici_xgbrf, f'Z:\\Nathan\\Models\\student_risk\\models\\trici_ft_tr_4yr_model_v{sklearn.__version__}.pkl')

#%%
# University model output
joblib.dump(univr_xgbrf, f'Z:\\Nathan\\Models\\student_risk\\models\\univr_ft_tr_4yr_model_v{sklearn.__version__}.pkl')
