...
validation_set = pd.read_csv('Z:\\Nathan\\Models\\student_risk\\datasets\\tran_2_validation_set.csv', encoding='utf-8', low_memory=False)
training_set = pd.read_csv('Z:\\Nathan\\Models\\student_risk\\datasets\\tran_2_training_set.csv', encoding='utf-8', low_memory=False)
testing_set = pd.read_csv('Z:\\Nathan\\Models\\student_risk\\datasets\\tran_2_testing_set.csv', encoding='utf-8', low_memory=False)
...
pullm_training_outlier_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\pullm_degr_training_outlier_set.csv', encoding='utf-8', index=False)
pullm_validation_outlier_set = pullm_validation_set.drop(pullm_validation_set[pullm_validation_set['mask'] == 1].index)
pullm_validation_outlier_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\pullm_degr_validation_outlier_set.csv', encoding='utf-8', index=False)
...
vanco_training_outlier_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\vanco_degr_training_outlier_set.csv', encoding='utf-8', index=False)
vanco_validation_outlier_set = vanco_validation_set.drop(vanco_validation_set[vanco_validation_set['mask'] == 1].index)
vanco_validation_outlier_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\vanco_degr_validation_outlier_set.csv', encoding='utf-8', index=False)
...
trici_training_outlier_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\trici_degr_training_outlier_set.csv', encoding='utf-8', index=False)
trici_validation_outlier_set = trici_validation_set.drop(trici_validation_set[trici_validation_set['mask'] == 1].index)
trici_validation_outlier_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\trici_degr_validation_outlier_set.csv', encoding='utf-8', index=False)
...
univr_training_outlier_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\univr_degr_training_outlier_set.csv', encoding='utf-8', index=False)
univr_validation_outlier_set = univr_validation_set.drop(univr_validation_set[univr_validation_set['mask'] == 1].index)
univr_validation_outlier_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\univr_degr_validation_outlier_set.csv', encoding='utf-8', index=False)
...
pullm_tomek_train_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\pullm_degr_tomek_training_set.csv', encoding='utf-8', index=False)
pullm_tomek_valid_set = pullm_validation_set.drop(pullm_tomek_valid_index)
pullm_tomek_valid_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\pullm_degr_tomek_validation_set.csv', encoding='utf-8', index=False)
...
vanco_tomek_train_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\vanco_degr_tomek_training_set.csv', encoding='utf-8', index=False)
vanco_tomek_valid_set = vanco_validation_set.drop(vanco_tomek_valid_index)
vanco_tomek_valid_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\vanco_degr_tomek_validation_set.csv', encoding='utf-8', index=False)
...
trici_tomek_train_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\trici_degr_tomek_training_set.csv', encoding='utf-8', index=False)
trici_tomek_valid_set = trici_validation_set.drop(trici_tomek_valid_index)
trici_tomek_valid_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\trici_degr_tomek_validation_set.csv', encoding='utf-8', index=False)
...
univr_tomek_train_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\univr_degr_tomek_training_set.csv', encoding='utf-8', index=False)
univr_tomek_valid_set = univr_validation_set.drop(univr_tomek_valid_index)
univr_tomek_valid_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\univr_degr_tomek_validation_set.csv', encoding='utf-8', index=False)
