...
import shap
from student_risk import build_degr_prod, config
...
validation_set = pd.read_csv('Z:\\Nathan\\Models\\student_risk\\datasets\\degr_validation_set.csv', encoding='utf-8', low_memory=False)
training_set = pd.read_csv('Z:\\Nathan\\Models\\student_risk\\datasets\\degr_training_set.csv', encoding='utf-8', low_memory=False)
testing_set = pd.read_csv('Z:\\Nathan\\Models\\student_risk\\datasets\\degr_testing_set.csv', encoding='utf-8', low_memory=False)
...
vanco_testing_set = testing_set[(testing_set['adj_acad_prog_primary_campus'] == 'VANCO')][vanco_data_vars].dropna().drop(columns=['degree_ind'])
...
trici_testing_set = testing_set[(testing_set['adj_acad_prog_primary_campus'] == 'TRICI')][trici_data_vars].dropna().drop(columns=['degree_ind'])
...
univr_testing_set = testing_set[((testing_set['adj_acad_prog_primary_campus'] == 'EVERE')) 
								...
								| ((testing_set['adj_acad_prog_primary_campus'] == 'ONLIN'))][univr_data_vars].dropna().drop(columns=['degree_ind'])
...
pullm_training_outlier_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\pullm_soph_training_outlier_set.csv', encoding='utf-8', index=False)
pullm_validation_outlier_set = pullm_validation_set.drop(pullm_validation_set[pullm_validation_set['mask'] == 1].index)
pullm_validation_outlier_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\pullm_soph_validation_outlier_set.csv', encoding='utf-8', index=False)
...
#%%
# Vancouver outliers
vanco_x_training_outlier = vanco_training_set.drop(columns=['degree_ind','emplid'])
vanco_x_validation_outlier = vanco_validation_set.drop(columns=['degree_ind','emplid'])
...
vanco_training_outlier_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\vanco_soph_training_outlier_set.csv', encoding='utf-8', index=False)
vanco_validation_outlier_set = vanco_validation_set.drop(vanco_validation_set[vanco_validation_set['mask'] == 1].index)
vanco_validation_outlier_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\vanco_soph_validation_outlier_set.csv', encoding='utf-8', index=False)
...
#%%
# Tri-Cities outliers
trici_x_training_outlier = trici_training_set.drop(columns=['degree_ind','emplid'])
trici_x_validation_outlier = trici_validation_set.drop(columns=['degree_ind','emplid'])
...
trici_training_outlier_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\trici_soph_training_outlier_set.csv', encoding='utf-8', index=False)
trici_validation_outlier_set = trici_validation_set.drop(trici_validation_set[trici_validation_set['mask'] == 1].index)
trici_validation_outlier_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\trici_soph_validation_outlier_set.csv', encoding='utf-8', index=False)
...
#%%
# University outliers
univr_x_training_outlier = univr_training_set.drop(columns=['degree_ind','emplid'])
univr_x_validation_outlier = univr_validation_set.drop(columns=['degree_ind','emplid'])
...
univr_training_outlier_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\univr_soph_training_outlier_set.csv', encoding='utf-8', index=False)
univr_validation_outlier_set = univr_validation_set.drop(univr_validation_set[univr_validation_set['mask'] == 1].index)
univr_validation_outlier_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\univr_soph_validation_outlier_set.csv', encoding='utf-8', index=False)
...
pullm_tomek_train_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\pullm_soph_tomek_training_set.csv', encoding='utf-8', index=False)
pullm_tomek_valid_set = pullm_validation_set.drop(pullm_tomek_valid_index)
pullm_tomek_valid_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\pullm_soph_tomek_validation_set.csv', encoding='utf-8', index=False)

#%%
# Vancouver undersample
vanco_x_train = vanco_training_set.drop(columns=['degree_ind','emplid'])
vanco_x_cv = vanco_validation_set.drop(columns=['degree_ind','emplid'])

vanco_x_test = vanco_testing_set[vanco_tomek_vars]

vanco_y_train = vanco_training_set['degree_ind']
vanco_y_cv = vanco_validation_set['degree_ind']
# vanco_y_test = vanco_testing_set['degree_ind']
...
vanco_tomek_train_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\vanco_soph_tomek_training_set.csv', encoding='utf-8', index=False)
vanco_tomek_valid_set = vanco_validation_set.drop(vanco_tomek_valid_index)
vanco_tomek_valid_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\vanco_soph_tomek_validation_set.csv', encoding='utf-8', index=False)

#%%
# Tri-Cities undersample
trici_x_train = trici_training_set.drop(columns=['degree_ind','emplid'])
trici_x_cv = trici_validation_set.drop(columns=['degree_ind','emplid'])

trici_x_test = trici_testing_set[trici_tomek_vars]

trici_y_train = trici_training_set['degree_ind']
trici_y_cv = trici_validation_set['degree_ind']
# trici_y_test = trici_testing_set['degree_ind']
...
trici_tomek_train_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\trici_soph_tomek_training_set.csv', encoding='utf-8', index=False)
trici_tomek_valid_set = trici_validation_set.drop(trici_tomek_valid_index)
trici_tomek_valid_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\trici_soph_tomek_validation_set.csv', encoding='utf-8', index=False)

#%%
# University undersample
univr_x_train = univr_training_set.drop(columns=['degree_ind','emplid'])
univr_x_cv = univr_validation_set.drop(columns=['degree_ind','emplid'])

univr_x_test = univr_testing_set[univr_tomek_vars]

univr_y_train = univr_training_set['degree_ind']
univr_y_cv = univr_validation_set['degree_ind']
# univr_y_test = univr_testing_set['degree_ind']
...
univr_tomek_train_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\univr_soph_tomek_training_set.csv', encoding='utf-8', index=False)
univr_tomek_valid_set = univr_validation_set.drop(univr_tomek_valid_index)
univr_tomek_valid_set.to_csv('Z:\\Nathan\\Models\\student_risk\\outliers\\univr_soph_tomek_validation_set.csv', encoding='utf-8', index=False)
...
try:
	pullm_y, pullm_x = dmatrices('enrl_ind ~ acad_level_bot_descr + male + underrep_minority + pell_eligibility_ind + first_gen_flag + first_gen_flag_mi \
...
try:
	vanco_y, vanco_x = dmatrices('degree_ind ~ male + underrep_minority + pell_eligibility_ind + first_gen_flag + first_gen_flag_mi \
					+ fall_avg_difficulty + fall_avg_pct_CDF + fall_avg_pct_withdrawn \
...
try:
	trici_y, trici_x = dmatrices('degree_ind ~ male + underrep_minority + pell_eligibility_ind + first_gen_flag + first_gen_flag_mi \
					+ fall_avg_difficulty + fall_avg_pct_CDF + fall_avg_pct_withdrawn \
					+ fall_lec_count + fall_lab_count \
					+ cum_gpa + cum_gpa_hours \
					+ total_fall_units \
...
try:
	univr_y, univr_x = dmatrices('degree_ind ~ male + underrep_minority + pell_eligibility_ind + first_gen_flag + first_gen_flag_mi \
					+ fall_avg_difficulty + fall_avg_pct_CDF + fall_avg_pct_withdrawn \
					+ fall_lec_count + fall_lab_count \
					+ cum_gpa + cum_gpa_hours \
					+ total_fall_units \
...
# pullm_class_weight = pullm_y_train[pullm_y_train == 0].count() / pullm_y_train[pullm_y_train == 1].count()
# pullm_rf = XGBRFClassifier(tree_method='hist', grow_policy='depthwise', subsample=0.8, colsample_bynode=0.8, scale_pos_weight=pullm_class_weight, 
...
# vanco_class_weight = vanco_y_train[vanco_y_train == 0].count() / vanco_y_train[vanco_y_train == 1].count()
# vanco_rf = XGBRFClassifier(tree_method='hist', grow_policy='depthwise', subsample=0.8, colsample_bynode=0.8, scale_pos_weight=vanco_class_weight, 
...
# trici_class_weight = trici_y_train[trici_y_train == 0].count() / trici_y_train[trici_y_train == 1].count()
# trici_rf = XGBRFClassifier(tree_method='hist', grow_policy='depthwise', subsample=0.8, colsample_bynode=0.8, scale_pos_weight=trici_class_weight, 
...
# univr_class_weight = univr_y_train[univr_y_train == 0].count() / univr_y_train[univr_y_train == 1].count()
# univr_rf = XGBRFClassifier(tree_method='hist', grow_policy='depthwise', subsample=0.8, colsample_bynode=0.8, scale_pos_weight=univr_class_weight, 
...
pullm_class_weight = pullm_y_train[pullm_y_train == 0].count() / pullm_y_train[pullm_y_train == 1].count()
pullm_xgbrf = XGBClassifier(tree_method='hist', grow_policy='depthwise', num_parallel_tree=10, subsample=0.8, colsample_bynode=0.8, scale_pos_weight=pullm_class_weight, 
								eval_metric='logloss', **pullm_gridsearch.best_params_, use_label_encoder=False, n_jobs=-1).fit(pullm_x_train, pullm_y_train, eval_set=[(pullm_x_cv, pullm_y_cv)], early_stopping_rounds=20, verbose=False)
...
vanco_class_weight = vanco_y_train[vanco_y_train == 0].count() / vanco_y_train[vanco_y_train == 1].count()
vanco_xgbrf = XGBClassifier(tree_method='hist', grow_policy='depthwise', num_parallel_tree=10, subsample=0.8, colsample_bynode=0.8, scale_pos_weight=vanco_class_weight, 
								eval_metric='logloss', **vanco_gridsearch.best_params_, use_label_encoder=False, n_jobs=-1).fit(vanco_x_train, vanco_y_train, eval_set=[(vanco_x_cv, vanco_y_cv)], early_stopping_rounds=20, verbose=False)
...
trici_class_weight = trici_y_train[trici_y_train == 0].count() / trici_y_train[trici_y_train == 1].count()
trici_xgbrf = XGBClassifier(tree_method='hist', grow_policy='depthwise', num_parallel_tree=10, subsample=0.8, colsample_bynode=0.8, scale_pos_weight=trici_class_weight, 
								eval_metric='logloss', **trici_gridsearch.best_params_, use_label_encoder=False, n_jobs=-1).fit(trici_x_train, trici_y_train, eval_set=[(trici_x_cv, trici_y_cv)], early_stopping_rounds=20, verbose=False)
...
univr_class_weight = univr_y_train[univr_y_train == 0].count() / univr_y_train[univr_y_train == 1].count()
univr_xgbrf = XGBClassifier(tree_method='hist', grow_policy='depthwise', num_parallel_tree=10, subsample=0.8, colsample_bynode=0.8, scale_pos_weight=univr_class_weight, 
								eval_metric='logloss', **univr_gridsearch.best_params_, use_label_encoder=False, n_jobs=-1).fit(univr_x_train, univr_y_train, eval_set=[(univr_x_cv, univr_y_cv)], early_stopping_rounds=20, verbose=False)
...
pullm_pred_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\pullm\\pullm_soph_pred_outcome.csv', encoding='utf-8', index=False)
...
vanco_pred_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\vanco\\vanco_soph_pred_outcome.csv', encoding='utf-8', index=False)
...
trici_pred_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\trici\\trici_soph_pred_outcome.csv', encoding='utf-8', index=False)
...
univr_pred_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\univr\\univr_soph_pred_outcome.csv', encoding='utf-8', index=False)
...
pullm_aggregate_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\pullm\\pullm_soph_aggregate_outcome.csv', encoding='utf-8', index=False)
...
vanco_aggregate_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\vanco\\vanco_soph_aggregate_outcome.csv', encoding='utf-8', index=False)
...
trici_aggregate_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\trici\\trici_soph_aggregate_outcome.csv', encoding='utf-8', index=False)
...
univr_aggregate_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\univr\\univr_soph_aggregate_outcome.csv', encoding='utf-8', index=False)
...
if not os.path.isfile('Z:\\Nathan\\Models\\student_risk\\predictions\\pullm\\pullm_soph_student_outcome.csv'):
	pullm_current_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\pullm\\pullm_soph_student_outcome.csv', encoding='utf-8', index=False)
	pullm_current_outcome.to_sql('student_outcome', con=auto_engine, if_exists='append', index=False, schema='oracle_int.dbo')
else:
	pullm_prior_outcome = pd.read_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\pullm\\pullm_soph_student_outcome.csv', encoding='utf-8', low_memory=False)
	pullm_prior_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\pullm\\pullm_soph_student_backup.csv', encoding='utf-8', index=False)
	pullm_student_outcome = pd.concat([pullm_prior_outcome, pullm_current_outcome])
	pullm_student_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\pullm\\pullm_soph_student_outcome.csv', encoding='utf-8', index=False)
	pullm_current_outcome.to_sql('student_outcome', con=auto_engine, if_exists='append', index=False, schema='oracle_int.dbo')

#%%
# Vancouver to csv and to sql
if not os.path.isfile('Z:\\Nathan\\Models\\student_risk\\predictions\\vanco\\vanco_soph_student_outcome.csv'):
	vanco_current_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\vanco\\vanco_soph_student_outcome.csv', encoding='utf-8', index=False)
	vanco_current_outcome.to_sql('student_outcome', con=auto_engine, if_exists='append', index=False, schema='oracle_int.dbo')
else:
	vanco_prior_outcome = pd.read_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\vanco\\vanco_soph_student_outcome.csv', encoding='utf-8', low_memory=False)
	vanco_prior_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\vanco\\vanco_soph_student_backup.csv', encoding='utf-8', index=False)
	vanco_student_outcome = pd.concat([vanco_prior_outcome, vanco_current_outcome])
	vanco_student_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\vanco\\vanco_soph_student_outcome.csv', encoding='utf-8', index=False)
	vanco_current_outcome.to_sql('student_outcome', con=auto_engine, if_exists='append', index=False, schema='oracle_int.dbo')

#%%
# Tri-Cities to csv and to sql
if not os.path.isfile('Z:\\Nathan\\Models\\student_risk\\predictions\\trici\\trici_soph_student_outcome.csv'):
	trici_current_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\trici\\trici_soph_student_outcome.csv', encoding='utf-8', index=False)
	trici_current_outcome.to_sql('student_outcome', con=auto_engine, if_exists='append', index=False, schema='oracle_int.dbo')
else:
	trici_prior_outcome = pd.read_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\trici\\trici_soph_student_outcome.csv', encoding='utf-8', low_memory=False)
	trici_prior_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\trici\\trici_soph_student_backup.csv', encoding='utf-8', index=False)
	trici_student_outcome = pd.concat([trici_prior_outcome, trici_current_outcome])
	trici_student_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\trici\\trici_soph_student_outcome.csv', encoding='utf-8', index=False)
	trici_current_outcome.to_sql('student_outcome', con=auto_engine, if_exists='append', index=False, schema='oracle_int.dbo')

#%%
# University to csv and to sql
if not os.path.isfile('Z:\\Nathan\\Models\\student_risk\\predictions\\univr\\univr_soph_student_outcome.csv'):
	univr_current_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\univr\\univr_soph_student_outcome.csv', encoding='utf-8', index=False)
	univr_current_outcome.to_sql('student_outcome', con=auto_engine, if_exists='append', index=False, schema='oracle_int.dbo')
else:
	univr_prior_outcome = pd.read_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\univr\\univr_soph_student_outcome.csv', encoding='utf-8', low_memory=False)
	univr_prior_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\univr\\univr_soph_student_backup.csv', encoding='utf-8', index=False)
	univr_student_outcome = pd.concat([univr_prior_outcome, univr_current_outcome])
	univr_student_outcome.to_csv('Z:\\Nathan\\Models\\student_risk\\predictions\\univr\\univr_soph_student_outcome.csv', encoding='utf-8', index=False)
	univr_current_outcome.to_sql('student_outcome', con=auto_engine, if_exists='append', index=False, schema='oracle_int.dbo')

#%%
# Pullman top-N SHAP values to csv and to sql
pullm_shap_file = open('Z:\\Nathan\\Models\\student_risk\\shap\\pullm\\pullm_soph_shap.csv', 'w', newline='')
...
vanco_shap_file = open('Z:\\Nathan\\Models\\student_risk\\shap\\vanco\\vanco_soph_shap.csv', 'w', newline='')
...
trici_shap_file = open('Z:\\Nathan\\Models\\student_risk\\shap\\trici\\trici_soph_shap.csv', 'w', newline='')
...
univr_shap_file = open('Z:\\Nathan\\Models\\student_risk\\shap\\univr\\univr_soph_shap.csv', 'w', newline='')
...
joblib.dump(pullm_xgbrf, f'Z:\\Nathan\\Models\\student_risk\\models\\pullm_soph_model_v{sklearn.__version__}.pkl')

#%%
# Vancouver model output
joblib.dump(vanco_xgbrf, f'Z:\\Nathan\\Models\\student_risk\\models\\vanco_soph_model_v{sklearn.__version__}.pkl')

#%%
# Tri-Cities model output
joblib.dump(trici_xgbrf, f'Z:\\Nathan\\Models\\student_risk\\models\\trici_soph_model_v{sklearn.__version__}.pkl')

#%%
# University model output
joblib.dump(univr_xgbrf, f'Z:\\Nathan\\Models\\student_risk\\models\\univr_soph_model_v{sklearn.__version__}.pkl')
