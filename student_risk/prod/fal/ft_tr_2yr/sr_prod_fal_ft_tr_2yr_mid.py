...
validation_set = pd.read_csv('Z:\\Nathan\\Models\\student_risk\\datasets\\ft_tr_2yr_validation_set.csv', encoding='utf-8', low_memory=False)
training_set = pd.read_csv('Z:\\Nathan\\Models\\student_risk\\datasets\\ft_tr_2yr_training_set.csv', encoding='utf-8', low_memory=False)
testing_set = pd.read_csv('Z:\\Nathan\\Models\\student_risk\\datasets\\ft_tr_2yr_testing_set.csv', encoding='utf-8', low_memory=False)
