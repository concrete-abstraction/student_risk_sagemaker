...
census_day = calendar[(calendar['STRM'] == strm)]['census_day'].values[0]
census_month = calendar[(calendar['STRM'] == strm)]['census_month'].values[0]
census_year = calendar[(calendar['STRM'] == strm)]['census_year'].values[0]
