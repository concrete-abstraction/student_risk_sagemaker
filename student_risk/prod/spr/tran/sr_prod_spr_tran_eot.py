...
pullm_xgb = XGBClassifier(n_estimators=1000, max_depth=11, use_label_encoder=False, gamma=12, scale_pos_weight=class_weight, subsample=0.8, colsample_bynode=0.8, eval_metric='logloss').fit(pullm_x_train, pullm_y_train)
...
vanco_xgb = XGBClassifier(n_estimators=1000, max_depth=10, use_label_encoder=False, gamma=12, scale_pos_weight=class_weight, subsample=0.8, colsample_bynode=0.8, eval_metric='logloss').fit(vanco_x_train, vanco_y_train)
...
trici_xgb = XGBClassifier(n_estimators=150, max_depth=6, use_label_encoder=False, gamma=15, scale_pos_weight=class_weight, subsample=0.8, colsample_bynode=0.8, eval_metric='logloss').fit(trici_x_train, trici_y_train)
...
univr_xgb = XGBClassifier(n_estimators=150, max_depth=6, use_label_encoder=False, gamma=15, scale_pos_weight=class_weight, subsample=0.8, colsample_bynode=0.8, eval_metric='logloss').fit(univr_x_train, univr_y_train)
