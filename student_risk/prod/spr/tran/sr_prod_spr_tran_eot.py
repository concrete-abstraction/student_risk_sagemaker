...
pullm_xgb = XGBClassifier(n_estimators=5000, random_state=np.random.randint(np.iinfo(np.int32).max), eta=1, max_depth=7, use_label_encoder=False, gamma=12, scale_pos_weight=class_weight, subsample=0.8, colsample_bynode=0.8, eval_metric='logloss').fit(pullm_x_train, pullm_y_train)
...
vanco_xgb = XGBClassifier(n_estimators=5000, random_state=np.random.randint(np.iinfo(np.int32).max), eta=1, max_depth=6, use_label_encoder=False, gamma=8, scale_pos_weight=class_weight, subsample=0.8, colsample_bynode=0.8, eval_metric='logloss').fit(vanco_x_train, vanco_y_train)
...
trici_xgb = XGBClassifier(n_estimators=5000, random_state=np.random.randint(np.iinfo(np.int32).max), eta=1, max_depth=5, use_label_encoder=False, gamma=3, scale_pos_weight=class_weight, subsample=0.8, colsample_bynode=0.8, eval_metric='logloss').fit(trici_x_train, trici_y_train)
...
univr_xgb = XGBClassifier(n_estimators=5000, random_state=np.random.randint(np.iinfo(np.int32).max), eta=1, max_depth=6, use_label_encoder=False, gamma=12, scale_pos_weight=class_weight, subsample=0.8, colsample_bynode=0.8, eval_metric='logloss').fit(univr_x_train, univr_y_train)
