...
pullm_xgb_ccv = XGBRFClassifier(n_estimators=500, max_depth=5, gamma=1, random_state=np.random.randint(np.iinfo(np.int32).max), scale_pos_weight=pullm_class_weight, eval_metric='logloss', use_label_encoder=False).fit(pullm_x_train, pullm_y_train)

# Pullman XGB calibration
# pullm_xgb = XGBClassifier(n_estimators=1000, max_depth=5, gamma=0, scale_pos_weight=pullm_class_weight, eval_metric='logloss', use_label_encoder=False)
...
vanco_xgb_ccv = XGBRFClassifier(n_estimators=500, max_depth=5, gamma=7, random_state=np.random.randint(np.iinfo(np.int32).max), scale_pos_weight=vanco_class_weight, eval_metric='logloss', use_label_encoder=False).fit(vanco_x_train, vanco_y_train)

# Vancouver XGB calibration
# vanco_xgb = XGBRFClassifier(n_estimators=500, max_depth=5, gamma=7, scale_pos_weight=vanco_class_weight, eval_metric='logloss', use_label_encoder=False)
...
trici_xgb_ccv = XGBRFClassifier(n_estimators=500, max_depth=6, gamma=4, random_state=np.random.randint(np.iinfo(np.int32).max), scale_pos_weight=trici_class_weight, eval_metric='logloss', use_label_encoder=False).fit(trici_x_train, trici_y_train)

# Tri-Cities XGB calibration
# trici_xgb = XGBRFClassifier(n_estimators=500, max_depth=6, gamma=4, scale_pos_weight=trici_class_weight, eval_metric='logloss', use_label_encoder=False)
...
univr_xgb_ccv = XGBRFClassifier(n_estimators=500, max_depth=5, gamma=3, random_state=np.random.randint(np.iinfo(np.int32).max), scale_pos_weight=univr_class_weight, eval_metric='logloss', use_label_encoder=False).fit(univr_x_train, univr_y_train)

# University XGB calibration
# univr_xgb = XGBRFClassifier(n_estimators=500, max_depth=5, gamma=3, scale_pos_weight=univr_class_weight, eval_metric='logloss', use_label_encoder=False)
