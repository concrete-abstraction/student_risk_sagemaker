...
#%%
# Random forest model
rfc = RandomForestClassifier(n_estimators=500, class_weight='balanced', max_depth=10, max_features='sqrt', min_samples_split=2, min_samples_leaf=1, verbose=True).fit(x_train, y_train)
