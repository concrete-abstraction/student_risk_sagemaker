...
#%%
# Pullman logistic
pullm_lreg = LogisticRegression(penalty='elasticnet', solver='saga', class_weight='balanced', max_iter=1000, l1_ratio=0.0, C=1.0, n_jobs=-1, verbose=False).fit(pullm_x_train, pullm_y_train)
...
#%%
# Vancouver logistic
vanco_lreg = LogisticRegression(penalty='elasticnet', solver='saga', class_weight='balanced', max_iter=1000, l1_ratio=0.0, C=1.0, n_jobs=-1, verbose=False).fit(vanco_x_train, vanco_y_train)
...
#%%
# Tri-Cities logistic
trici_lreg = LogisticRegression(penalty='elasticnet', solver='saga', class_weight='balanced', max_iter=1000, l1_ratio=0.0, C=1.0, n_jobs=-1, verbose=False).fit(trici_x_train, trici_y_train)
